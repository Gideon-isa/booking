...
func TestRepository_Reservation(t *testing.T) {
	...
	if rr.Code != http.StatusOK {
		t.Errorf("Reservation handler returned wrong reponse code: got %d, wanted %d", rr.Code, http.StatusOK)
	}
...
func TestRepository_PostReservation(t *testing.T) {
	...
	reqBody = fmt.Sprintf("%s&%s", reqBody, "email=innocent10@gmail.com")
	...
	if rr.Code != http.StatusSeeOther {
		t.Errorf("PostReservation handler returned wrong reponses code: got %d, wanted %d", rr.Code, http.StatusSeeOther)
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("PostReservation handler returned wrong reponses code for missing post: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("PostReservation handler returned wrong reponses code for invalid start date: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("PostReservation handler returned wrong reponses code for invalid end date: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("PostReservation handler returned wrong reponses code for invalid room id: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	...
	if rr.Code != http.StatusSeeOther {
		t.Errorf("PostReservation handler returned wrong reponses code for invalid data: got %d, wanted %d", rr.Code, http.StatusSeeOther)
